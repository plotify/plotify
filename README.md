...
<table>
    <tr>
        <td align="center" width="50%">
            <a href="https://github.com/SebastianSchmidt/plotify/releases/download/v0.1.0/plotify-0.1.0-windows-x64.exe">
                <img src="docs/windows-logo.png" />
            </a>
         </td>
        <td align="center" width="50%">
            <a href="https://github.com/SebastianSchmidt/plotify/releases/download/v0.1.0/plotify-0.1.0-windows-amd64.deb">
    ...
    <tr>
        <td align="center">
            <a href="https://github.com/SebastianSchmidt/plotify/releases/download/v0.1.0/plotify-0.1.0-linux-x64.exe">
                <b>Windows</b><br />
                Windows 7, 8, 10
            </a>
        </td>
        <td align="center">
            <a href="https://github.com/SebastianSchmidt/plotify/releases/download/v0.1.0/plotify-0.1.0-linux-amd64.deb">
                <b>Linux</b><br />
